...
- **Đã xong C1/C2:** streak mưa (LineSegments) · sét flash (AmbientLight) · tuyết đọng NỀN ([[SnowCover]])
- **Phase C còn (đụng vùng nhạy):** nền ướt mưa (GỠ — NgQuan làm lại từng bước) · wetness tường/mái per-material (material per-key = Factory) · tuyết bám MÁI (geometry mái) · mưa gợn mặt hồ (WaterSurface reflector) · cỏ/cây nghiêng gió bão (GrassBlades wind)
