...
| `PondFish` | 🐟 Đàn cá koi PROCEDURAL bơi lòng hồ — thân low-poly ~131 tri/con, đuôi vẫy TSL vertex-bend GPU (0 rig/0 asset/0 texture), màu koi trắng+cam+đốm per-con (hash+triNoise3D), wander CPU rẻ, cả đàn 1 draw. Phase B = ráp basin hồ archplan | fish, koi, cá, pond, water, instanced, vertex-animation, site-kit | 🆕 module |
