...
|------|---------------|---------|
| [Structure.ts](Structure.ts) | makePositionedFoundation, makePositionedSlab, makePositionedColumn | Móng (concrete / wood-deck lưới cột / **stone-pillar**: trụ đá giữa + 2 tầng 8 xà toả tâm + 8 trụ dọc tròn + 8 chống xiên @45° uốn-cong-được), sàn bê tông, cột tròn/vuông |
