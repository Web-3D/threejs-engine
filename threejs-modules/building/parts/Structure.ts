...
// ── Positioned Balcony + Stairs — TÁCH ra file riêng (part-builder độc lập) ────
// Mỗi part 1 file: parts/Balcony.ts (sàn vươn + lan can 4 style), parts/Stairs.ts (bậc 5 style). Re-export
// barrel để consumer (building/render/fromState) giữ NGUYÊN import 'building-kit/parts/Structure'.
export { makePositionedBalcony, type PositionedBalconyOpts } from './Balcony'
export { makePositionedStairs, type PositionedStairsOpts } from './Stairs'
